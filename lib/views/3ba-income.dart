...
class _IncomeState extends State<Income> {
  ...
  final CreateIncomeTransactionViewModel _viewModel = CreateIncomeTransactionViewModel(TransactionRepository());
  ...
  List<CategoryBadge> chips = [
    ...
    CategoryBadge(category: 'College',),
    CategoryBadge(category: 'Loan',)
  ];

...
class ActionsOnTransactionBottomSheet extends StatefulWidget {
  final Transaction transaction;
  const ActionsOnTransactionBottomSheet({super.key, required this.transaction});

  @override
  State<ActionsOnTransactionBottomSheet> createState() =>
      _ActionsOnTransactionBottomSheetState();
}

class _ActionsOnTransactionBottomSheetState
    extends State<ActionsOnTransactionBottomSheet> {
  bool _readOnly = true;

  TextEditingController _dateInput = TextEditingController(
      text: DateFormat('yyyy-MM-dd').format(DateTime.now()));
  TextEditingController _nameInput = TextEditingController(text: "table");
  TextEditingController _priceInput =
      TextEditingController(text: "25 000" + " DA");

  final ActionTransactionViewModel viewModel =
      ActionTransactionViewModel(TransactionRepository());
  @override
